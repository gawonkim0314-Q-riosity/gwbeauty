...
} from "@/admin/services/_hooks/use-service-detail-admin";
...
import {
  ...
  detailToForm,
  emptyFormsByLocale,
} from "@/admin/services/_lib/detail-form";
import { FormCard, FormField } from "@/admin/services/_components/FormUi";

export function ServiceDetailEditor({ serviceId }: { serviceId: number }) {
  const router = useRouter();

  const [locale, setLocale] = useState<Locale>("ko");
  const [forms, setForms] = useState<Record<Locale, DetailForm>>(emptyFormsByLocale());
