    ...
    <section className="section-container py-24 md:py-32">
      ...
      <div className="mb-16 text-center">
        ...
        <h2 className="section-title mt-4">
          의료진 <span className="accent">소개</span>
        </h2>
      </div>

      {/* Lead doctor full-width block */}
      <div
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="relative w-full lg:w-[38%] min-h-[420px] lg:min-h-[600px]">
            ...
            <div className="absolute bottom-0 left-0 p-6 lg:hidden">
              ...
              <p className="mt-1 font-display text-2xl text-white" style={{ fontFamily: "var(--font-display-var), serif" }}>
                {doc.name}
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col justify-start gap-8 p-8 lg:w-[62%] lg:p-12" style={{ background: "var(--bg)" }}>
            ...
            <div className="hidden lg:block">
              ...
              <p className="mt-2 text-[0.75rem] italic text-[var(--text-3)] leading-relaxed">
                "{doc.tagline}"
              </p>
            </div>
              ...
              {INFO_BLOCKS.map(({ icon: Icon, label, key, color, bg }) => (
                <div key={key} className="flex flex-col gap-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-[0.65rem] font-bold tracking-[0.18em] uppercase text-[var(--text-3)]">
                      {label}
                    </span>
                  </div>
                  <ul className="space-y-1.5 pl-8">
                    {doc[key].map((item, i) => (
                      <li
                        key={i}
                        className="relative text-[0.75rem] leading-relaxed text-[var(--text-2)]"
                      >
                        <span
                          className="absolute -left-4 top-[0.45em] h-1 w-1 rounded-full"
